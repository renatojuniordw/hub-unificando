# Prompt: skill-extractor-user (radar-unificando)

> Fonte: src/lib/core/ai/prompts/skill-extractor.ts · const `SKILL_EXTRACTOR_USER_PROMPT`
> Arquivo gerado por `hub sync-docs` — não editar; a fonte é o .ts no repositório do projeto.

Extraia do currículo em markdown abaixo (o currículo pode estar em qualquer idioma):
